...
index_storage_dir = "C:\\Users\\laksh\\computer\\college\\hack to skill\\index_store_final\\vector"
if 'index_store_final' not in os.listdir():
    # Load documents
    documents = SimpleDirectoryReader("C:\\Users\\laksh\\computer\\college\\hack to skill\\hack4", recursive=True).load_data()
